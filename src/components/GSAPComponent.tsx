...
const GSAPComponent: React.FC<GSAPComponentProps> = ({ childRef }) => {
  useGSAP(() => {
    ...
    timeline
      ...
      .to(childRef.current.position, { x: 300, y: 100, z: 0 }, "joinDiscord")
